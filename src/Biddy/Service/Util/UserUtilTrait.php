...
trait UserUtilTrait
{
    private $correctSearchFields = ['idd' => 'id', 'name' => 'firstName'];
    ...
    private function addFilters(QueryBuilder $qb, PagerParam $param)
    {
        ...
        foreach ($searches as $searchField => $searchValue) {
            ...
            $searchField = array_key_exists($searchField, $this->correctSearchFields) ? $this->correctSearchFields[$searchField] : $searchField;
     ...
     * @return mixed
     */
    public function serializeSingleUser($user)
    {
