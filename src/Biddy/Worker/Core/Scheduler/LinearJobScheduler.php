...
use Biddy\Worker\Core\JobExpirerInterface;
...
class LinearJobScheduler implements LinearJobSchedulerInterface
{
    ...
    public function __construct(
        ...
        $processLinearJobName,
        $priorityKeyPrefix = 'linear_job_next_priority_tube_',
    ...
    protected function addProcessLinearJobTask($linearTubeName)
    {
