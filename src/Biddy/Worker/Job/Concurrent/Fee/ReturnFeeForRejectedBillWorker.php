...
class ReturnFeeForRejectedBillWorker implements JobInterface
{
    const JOB_NAME = 'ReturnFeeForRejectedBillWorker';
    ...
    /**
     * ReturnFeeForRejectedBillWorker constructor.
     * @param Logger $logger
    ...
    public function run(JobParams $params)
    {
        ...
        foreach ($billIds as $id) {
            ...
            $this->bidCreditManager->returnFeeForRejectedBill($bill);
        }
    }
}