...
class PayFeeForBillWorker implements JobInterface
{
    const JOB_NAME = 'PayFeeForBillWorker';
    ...
    /**
     * PayFeeForConfirmBillWorker constructor.
     * @param Logger $logger
    ...
    public function run(JobParams $params)
    {
        ...
        foreach ($billIds as $id) {
            ...
            $this->bidCreditManager->payFeeForBill($bill);
        }
    }
}