...
class UserController extends RestControllerAbstract implements ClassResourceInterface
{
     ...
     * @Rest\View(serializerGroups={"user.detail", "user.billing", "admin.detail"})
     * @ApiDoc(
     *  section = "admin",
     *  resource = true,
     *  statusCodes = {
     ...
     *      {"name"="role", "dataType"="string", "required"=true, "default"="account", "description"="The role of the user, i.e account or admin"},
    ...
    public function postUsersAction(Request $request)
    {
        ...
        return $this->get('biddy_admin_api.repository.user')->findAll();
    }
