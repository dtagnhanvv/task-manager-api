...
namespace Biddy\Bundle\UserSystem\AccountBundle\Entity;
...
class User extends BaseUser implements AccountInterface
{
    protected $id;
    protected $uuid;
     ...
     * @inheritdoc
     */
    public function setMasterAccount(AccountInterface $masterAccount = null)
    {
