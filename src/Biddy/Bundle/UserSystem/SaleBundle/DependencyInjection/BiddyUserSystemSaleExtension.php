...
namespace Biddy\Bundle\UserSystem\SaleBundle\DependencyInjection;
 ...
 */
class BiddyUserSystemSaleExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'biddy_user_system_sale_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('biddy_user_system_sale', array(
            array(
                /*
                ...
                'services_prefix' => 'biddy_user_system_sale',
                'routes_prefix' => 'biddy_user_system_sale',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Biddy\Bundle\UserSystem\SaleBundle\Entity\User',
                ...
                /*
                'group' => array(
                    'group_class' => 'Biddy\Bundle\UserSystem\SaleBundle\Entity\Group',
