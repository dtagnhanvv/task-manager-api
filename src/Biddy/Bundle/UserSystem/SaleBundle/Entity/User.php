...
namespace Biddy\Bundle\UserSystem\SaleBundle\Entity;
...
class User extends BaseUser implements SaleInterface
{
    protected $id;
    protected $uuid;
     ...
     * @inheritdoc
     */
    public function setMasterAccount(SaleInterface $masterAccount = null)
    {
