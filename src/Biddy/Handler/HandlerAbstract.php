...
use Biddy\DomainManager\MultiFormManagerInterface;
use ReflectionClass;
use ReflectionMethod;
use Symfony\Component\EventDispatcher\EventDispatcherInterface;
use Symfony\Component\Form\FormFactoryInterface;
use Symfony\Component\Form\FormTypeInterface;
use Biddy\DomainManager\ManagerInterface as DummyManagerInterface;
use Biddy\Exception\InvalidArgumentException;
use Biddy\Exception\InvalidFormException;
...
abstract class HandlerAbstract implements HandlerInterface
{
    ...
    public function post(array $parameters)
    {
        ...
        $entity = $this->domainManager->createNew($type);
    ...
    protected function processForm(ModelInterface $entity, array $parameters, $method = 'PUT')
    {
        ...
        $domainManager = $this->getDomainManager();

        if ($domainManager instanceof MultiFormManagerInterface) {
            $formType = $domainManager->getFormTypeByModel($entity);
            $formType = get_class($formType);
        } else {
