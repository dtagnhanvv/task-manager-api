...
use Biddy\Handler\Handlers\Core\CommentHandlerAbstract;
...
class CommentHandler extends CommentHandlerAbstract
{
     ...
     * @inheritdoc
     */
    protected function processForm(ModelInterface $comment, array $parameters, $method = "PUT")
    {
        /** @var CommentInterface $comment */
        if (null == $comment->getAuthor()) {
            $comment->setAuthor($this->getUserRole());
        }

        return parent::processForm($comment, $parameters, $method);
    }
}