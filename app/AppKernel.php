...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = array(
            ...
            new Biddy\Bundle\UserBundle\BiddyUserBundle(),
            new Biddy\Bundle\ApiBundle\BiddyApiBundle(),
            new Biddy\Bundle\AdminApiBundle\BiddyAdminApiBundle(),
            new Biddy\Bundle\SaleApiBundle\BiddySaleApiBundle(),
            new Biddy\Bundle\AppBundle\BiddyAppBundle(),
            new Biddy\Bundle\UserSystem\AccountBundle\BiddyUserSystemAccountBundle(),
            new Biddy\Bundle\UserSystem\SaleBundle\BiddyUserSystemSaleBundle(),
            new Biddy\Bundle\UserSystem\AdminBundle\BiddyUserSystemAdminBundle(),
            new Biddy\Bundle\PublicBundle\BiddyPublicBundle(),
...
//        $loader->load(__DIR__.'/config/config_'.$this->getEnvironment().'.yml');
    ...
    public function getCacheDir()
    {
        if ($this->isRunningOnDevelopmentVM()) {
            return '/dev/shm/biddy-api/var/cache/' . $this->environment;
        }
    ...
    {
        if ($this->isRunningOnDevelopmentVM()) {
            return '/dev/shm/biddy-api/var/logs';
        }
